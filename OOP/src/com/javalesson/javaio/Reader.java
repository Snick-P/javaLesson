...
public class Reader {
    ...
    public List<Student> readObject(String fileName) {
        ...
        try (ObjectInputStream in = new ObjectInputStream(Files.newInputStream(Paths.get(fileName)))) {
            ...
            while (keepReading) {
                ...
                if (!" ".equals(student.getStudentName()) && student.getAverageGrade() != -1) {
            ...
            System.out.println("Enable to open file " + fileName + " Program terminates");
            e.printStackTrace();
    ...
    //      Простой способ прочесть небольшой файл целиком
    ...
    public void nioReadWithChanel(String fileName) throws IOException {
