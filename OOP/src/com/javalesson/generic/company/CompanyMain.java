package com.javalesson.generic.company;

import com.javalesson.generic.company.employees.Accountant;
import com.javalesson.generic.company.employees.ITSpecialist;
import com.javalesson.generic.company.employees.Manager;
...
public class CompanyMain {
    public static void main(String[] args) {
        ...
        Department<ITSpecialist> itGuys = new Department("itGuys", 10);
