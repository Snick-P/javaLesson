...
public class ListRunner {
    ...
    while (param!=0){
        switch (param){
            ...
            case 5:
                ...
                System.out.println("Priority of the task "+ list.getTaskPriority(task5));
                System.out.println("Please choose an action by typing [0-6]");
                param = scanner.nextInt();
                break;
            case 6:
    ...
    private static void printOut() {
        System.out.println("Please choose an action. Press: \n"
                ...
                + "5 to get task priority or the number in the list; \n"
                + "6 to add a new items at specific position; \n"
                + "press 0 to exit. \n"
