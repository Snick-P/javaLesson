...
public class TreeMapRunner {
    ...
    private static void printGrades(Map<AverageStudentGrade, Set<SubjectGrade>> grades, boolean printValues) {
    ...
    public static NavigableMap<AverageStudentGrade, Set<SubjectGrade>> createGrades() {
        ...
        map.put(new AverageStudentGrade("James", calcAvarage(jamesGrades)), jamesGrades);
        map.put(new AverageStudentGrade("Antony", calcAvarage(antonyGrades)), antonyGrades);
        map.put(new AverageStudentGrade("Victoria", calcAvarage(victoriaGrades)), victoriaGrades);
